          ...
          <div class="box box-primary">
            ...
            echo '</select>
                ...
                <div class="form-group">
                  ...
                  <input type="text" name="MarcaItens" class="form-control" id="exampleInputEmail1" placeholder="Marca">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Modelo</label>
                  <input type="text" name="ModeloItens" class="form-control" id="exampleInputEmail1" placeholder="Modelo">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Memória</label>
                  <input type="text" name="MemoriaItens" class="form-control" id="exampleInputEmail1" placeholder="Memória">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Cor</label>
                  <input type="text" name="CorItens" class="form-control" id="exampleInputEmail1" placeholder="Cor">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Grade</label>
                  <input type="text" name="GradeItens" class="form-control" id="exampleInputEmail1" placeholder="Grade">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Local</label>
                  <input type="text" name="LocalItens" class="form-control" id="exampleInputEmail1" placeholder="Local">
                </div>
